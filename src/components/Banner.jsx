    ...
    <div className="max-w-7xl mx-auto rounded-lg overflow-hidden shadow-lg">
      ...
      >
        <SwiperSlide className="relative">
          <img src={s1} alt="" className="w-full h-[60vh] md:h-[75vh] lg:h-[90vh] object-cover" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/40 to-black/30 flex flex-col items-center justify-center space-y-4 sm:space-y-6 px-4 text-center">
            ...
            <button className="bg-white text-green-700 px-4 sm:px-6 py-2 sm:py-3 rounded font-semibold hover:bg-green-100 transition">
              Learn More
            </button>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className="relative">
          <img src={s2} alt="Urban Composting 101" className="w-full h-[60vh] md:h-[75vh] lg:h-[90vh] object-cover" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/40 to-black/30 flex flex-col items-center justify-center space-y-4 sm:space-y-6 px-4 text-center">
        ...
        <SwiperSlide className="relative">
          <img src={s3} alt="Vertical Gardening Masterclass" className="w-full h-[60vh] md:h-[75vh] lg:h-[90vh] object-cover" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/40 to-black/30 flex flex-col items-center justify-center space-y-4 sm:space-y-6 px-4 text-center">
